...
15. Определять любимый самолёт игрока. Любимый самолёт это тип самолёта, который игрок выбирал чаще.
Добавить на главную колонкой вместо налёта, а также добавить на страничку статистики пилота отдельным пунктом.
16. Определять сторону, за которую игрок заходил чаще. Добавить эту информацию на страничку пилота. По возможности, но очень желательно
