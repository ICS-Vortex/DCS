      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            Управление категориями юнитов DCS
        ...
        <section class="content">
            <div class="box">
                <div class="box-header">
                  <h3 class="box-title">Список юнитов DCS</h3>
                </div><!-- /.box-header -->
                <div class="box-body">
                <?if($result != '' && $result != 0){?>
                ...
                <form method="post" action="<?=base_url();?>admin/edit_units">
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>                    
                      ...
                      <tr>                                                
                        <td><input type="hidden" name="unit_name[]" value="<?=$item['name'];?>" /><?=$item['name'];?></td> 
                        <td><input class="form-control" name="unit_category[]" value="<?=$item['category'];?>" /></td>
                        <td><?=$item['country'];?></td>
