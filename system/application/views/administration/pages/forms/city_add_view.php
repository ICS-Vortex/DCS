...
<html>
  <head>
    ...
    <link href="/AdminLTE-master/plugins/iCheck/all.css" rel="stylesheet" type="text/css" />
    <!-- Bootstrap Color Picker -->
    <link href="/AdminLTE-master/plugins/colorpicker/bootstrap-colorpicker.min.css" rel="stylesheet"/>
    <!-- Bootstrap time Picker -->
    <link href="/AdminLTE-master/plugins/timepicker/bootstrap-timepicker.min.css" rel="stylesheet"/>
    <!-- Select2 -->
    <link href="/AdminLTE-master/plugins/select2/select2.min.css" rel="stylesheet" type="text/css" />
    <!-- Theme style -->
  ...
  <body class="skin-blue sidebar-mini">
          ...
          <div class="row">
            <div class="col-md-6">
              ...
              <div class="box box-danger">
                <div class="box-header">
                  <h3 class="box-title">Введіть логін користувача</h3>
                </div>
                <div class="box-body">
                  <!-- Date mm/dd/yyyy -->
            ...
            <div class="col-md-6">
              ...
              <div class="box box-success">
                <div class="box-header">
                  <h3 class="box-title">Прив’язка до міст</h3>
                </div>
                <div class="box-body">
                  <!-- Minimal style -->
                      ...
                      <!-- checkbox -->
                      <div class="form-group">
                        <input type="checkbox" name="cities[]" class="flat-red" checked />    <label>Обана</label>
                      </div>
                </div><!-- /.box-body -->
              </div><!-- /.box -->
            </div><!-- /.col (right) -->
    ...
    <!-- Select2 -->
    <script src="/AdminLTE-master/plugins/select2/select2.full.min.js" type="text/javascript"></script>
    <!-- InputMask -->
    <script src="/AdminLTE-master/plugins/input-mask/jquery.inputmask.js" type="text/javascript"></script>
    <script src="/AdminLTE-master//plugins/input-mask/jquery.inputmask.date.extensions.js" type="text/javascript"></script>
    <script src="/AdminLTE-master/plugins/input-mask/jquery.inputmask.extensions.js" type="text/javascript"></script>
    <!-- date-range-picker -->
    <script src="https://cdnjs.cloudflare.com/ajax/libs/moment.js/2.10.2/moment.min.js" type="text/javascript"></script>
    <script src="/AdminLTE-master/plugins/daterangepicker/daterangepicker.js" type="text/javascript"></script>
    <!-- bootstrap color picker -->
    <script src="/AdminLTE-master/plugins/colorpicker/bootstrap-colorpicker.min.js" type="text/javascript"></script>
    <!-- bootstrap time picker -->
    <script src="/AdminLTE-master/plugins/timepicker/bootstrap-timepicker.min.js" type="text/javascript"></script>
    <!-- SlimScroll 1.3.0 -->
