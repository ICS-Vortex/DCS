...
<link href="<?=base_url();?>wellcome/css/bootstrap.css" rel='stylesheet' type='text/css' />
<!-- jQuery (necessary for Bootstrap's JavaScript plugins) -->
<script src="<?=base_url();?>wellcome/js/jquery.min.js"></script>
<!-- Custom Theme files -->
<link href="<?=base_url();?>wellcome/css/style.css" rel="stylesheet" type="text/css" media="all" />
<!-- Custom Theme files -->
...
<body>
	...
	<div class="header">
		<div class="container">
			<div class="logo">
				<a href="index.html"><img src="<?=base_url();?>wellcome/images/logo.png" class="img-responsive" alt="" /></a>
			</div>
		...
		<div class="container">
			<div class="subscribe-section-grids">
				...
				<div class="col-md-4 book">
					<img src="<?=base_url();?>wellcome/images/book.png" alt="" >
				</div>
				<div class="clearfix"></div>
			</div>
		</div>
		...
		<div class="container">
			...
			<!---strat-image-cursuals---->
                  <div class="scroll-slider">											 
							...
							<li><img src="<?=base_url();?>wellcome/images/c1.jpg"></li>
							<li><img src="<?=base_url();?>wellcome/images/c2.jpg"></li>
							<li><img src="<?=base_url();?>wellcome/images/c3.jpg"></li>
							<li><img src="<?=base_url();?>wellcome/images/c4.jpg"></li>
							<li><img src="<?=base_url();?>wellcome/images/c1.jpg"></li>
							<li><img src="<?=base_url();?>wellcome/images/c2.jpg"></li>
							<li><img src="<?=base_url();?>wellcome/images/c3.jpg"></li>
							<li><img src="<?=base_url();?>wellcome/images/c4.jpg"></li>
							...
							<div class="clear"> </div>      
						  <!---strat-image-cursuals---->
								<script type="text/javascript" src="<?=base_url();?>wellcome/js/jquery.flexisel.js"></script>
								<!---End-image-cursuals---->
			...
			<div class="container">
				...
				<div class="members">
					<div class="col-md-4 member1">
						<img src="<?=base_url();?>wellcome/images/mem.jpg" alt="" />
			...
			<div class="container">
				...
				<div class="contact-top">
					<div class="col-md-4 contact-section-grid text-center">
						...
						<p>Phone : (568) 486-4586</p>
						<p>x : (568) 486-4586</p>
					</div>
					<div class="col-md-4 contact-section-grid text-center">
						<i class="user"></i>
						<p>Po box 45236<p>
						<p>Greater st, New york</p>
						<p>Vicrtoria 8423 USA</p>
					</div>
					<div class="col-md-4 contact-section-grid text-center">
						<i class="global"></i>
						<p><a href="mail-to:Support@yourname.com">Support@yourname.com</a></p>
						<p><a href="mail-to:hello@company.com">hello@company.com</a></p>
					</div>
					<div class="clearfix"></div>
				</div>				
			</div>
